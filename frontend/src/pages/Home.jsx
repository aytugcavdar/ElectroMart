    ...
    <div className="min-h-screen bg-base-200 p-4">
      <div className="hero bg-base-100 rounded-lg shadow-xl p-8 mb-8">
        <div className="hero-content text-center">
          <div>
            <h1 className="text-5xl font-bold text-primary">Ürünlerimiz</h1>
            <p className="py-6 text-lg">Kaliteli ürün yelpazemizi keşfedin.</p>
          </div>
        </div>
      </div>
          ...
          {products.map((product) => (
            ...
            >
              ...
              <div className="card-body">
                ...
                <p className="text-sm text-base-content opacity-70">{product.description}</p>
                <div className="flex justify-between items-center mt-2">
                  <span className="badge badge-outline">{product.category.name}</span>
                  <span className="badge badge-secondary">{product.brand.name}</span>
                </div>
